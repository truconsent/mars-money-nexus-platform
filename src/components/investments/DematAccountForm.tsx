...
export type DematAccountFormData = z.infer<typeof formSchema>;
...
export const DematAccountForm = ({ onBack }: DematAccountFormProps) => {
  ...
  const form = useForm<DematAccountFormData>({
  ...
  const onSubmit = async (data: DematAccountFormData) => {
      ...
      <CardHeader>
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <CardDescription>
              Powered by mars.money • Open your demat account quickly
            </CardDescription>
          </div>
        </div>
      </CardHeader>
