...
export const DematAccountForm = ({ onClose }: DematAccountFormProps) => {
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="flex gap-4 pt-4">
                ...
                <Button type="submit" className="flex-1 bg-gradient-to-r from-green-500 to-blue-600 hover:from-green-600 hover:to-blue-700">
                  Open Demat Account
                </Button>
              </div>
            </form>
